 ...
 * @author bounce
 */
public class OperationSettingsController implements Initializable {
    ...
    @FXML
    private StackPane SetingsStackpane;
    @FXML
    private Label label;
    ...
    @FXML
    private void GoToOperationsMenu(ActionEvent event) {
        PopWindow window = new PopWindow();  
        window.loadWindow("/View/OperationsMenu.fxml", "",true,true,false,false);
        SetingsStackpane.getScene().getWindow().hide();
    }

    @FXML
    private void ChangeUserImage(ActionEvent event) {
        pathname = "";
        ...
        if (file != null) {
            ...
            try {
                ...
                Logger.getLogger(OperationSettingsController.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
    ...
    @FXML
    private void UpdateUserSettings(ActionEvent event) {
    ...
    private void SetValues()
   {
        ...
        try
        {
           while(rs.next())
           {
               ...
               if(imagePath == null)
               {
                   imagePath.setText("insert user profile image");
               }
               else
               {
